		...
		<div id="ms">
			<div id="lf" style="float:left;">
				<div id="menuput" class="dbor">
					...
					<?php
					$mmenus = $menu->all(['parent' => 0, 'sh' => 1]);
					foreach ($mmenus as $key => $mmenu) {
					?>
						<div class="mainmu">
							<a href="<?= $mmenu['href']; ?>">
								<?= $mmenu['text']; ?>
							...
							<div class="mw">
								<?php
								$m_subs = $menu->all(['parent' => $mmenu['id']]);
								foreach ($m_subs as $key => $m_sub) {
								?>
									<div class="mainmu2">
										<a href="<?= $m_sub['href']; ?>">
											<?= $m_sub['text']; ?>
			...
			<div class="di di ad" style="height:540px; width:23%; padding:0px; margin-left:22px; float:left; ">
				...
				<div style="width:89%; height:480px;" class="dbor">
					...
					<div class="cent">
						...
						$image = new DB('image');
						$imgs = $image->all(['sh' => 1]);
						foreach ($imgs as $imgx => $img) {
						?>
							<img id="ssaa<?= $imgx; ?>" class="im" src="./img/<?= $img['img']; ?>" style="width:150px;height:103px">
						<?php
						}
						?>
					</div>
