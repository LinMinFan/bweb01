        ...
        <form method="post" action="./api/edit.php?do=<?=$do;?>">
            <table width="100%">
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td ><img src="./img/<?=$data['img'];?>" width="300px" height="30px"></td>
                        <td ><input type="text" name="text[]" value="<?=$data['text'];?>"></td>
                        <td ><input type="radio" name="sh[]" value="<?=$data['id'];?>" <?=($data['sh']==1)?"checked":"";?>></td>
