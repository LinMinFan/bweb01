    ...
    <div style="width:99%; height:87%; margin:auto; overflow:auto; border:#666 1px solid;">
        ...
        <form method="post" action="./api/edit.php?do=<?= $do; ?>">
            <table width="100%">
                <tbody>
                    <tr class="yel">
                        <td width="30%"><?= $str->btd[0]; ?></td>
                        <td width="30%"><?= $str->btd[1]; ?></td>
                        <td width="10%"><?= $str->btd[2]; ?></td>
                        <td width="7%">顯示</td>
                        <td width="7%">刪除</td>
                        <td></td>
                    </tr>
                    <?php
                    $dataTis = $$do->all(['parent'=>0]);
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                $sec=$$do->math('count','id',['parent'=>$value['id']]);
                                echo $sec;
                                ?>
                            </td>
                            <td>
                            ...
                            <td>
                            <td width="200px"><input type="button" onclick="op(&#39;#cover&#39;,&#39;#cvr&#39;,&#39;./modal/edit_sub.php?do=<?= $do; ?>&id=<?=$value['id'];?>&#39;)" value="<?= $str->upbtn; ?>"></td>
                            </td>
                        </tr>
